local TeleportFromTo = {	
	["Mission Row Police Station Interior Extended1"] = {
		positionFrom = { ['x'] = 452.13, ['y'] = -984.54, ['z'] = 26.67, nom = "Go to interrogation"},
		positionTo = { ['x'] = 442.14, ['y'] = -997.4, ['z'] = 4.8, nom = "Go to main room"},
	},
	["Mission Row Police Station Interior Extended2"] = {
		positionFrom = { ['x'] = 446.8, ['y'] = -986.37, ['z'] = 26.67, nom = "Go to briefing"},
		positionTo = { ['x'] = 442.12, ['y'] = -986.69, ['z'] = 4.8, nom = "Go to main room"},
	},
	["Mission Row Police Station Interior Extended3"] = {
		positionFrom = { ['x'] = 456.76, ['y'] = -985.94, ['z'] = 26.67, nom = "Go to storage"},
		positionTo = { ['x'] = 456.37, ['y'] = -1000.73, ['z'] = 4.8, nom = "Go to main room"},
	}	
}
